...
extends aj {
    ...
    private byte[] a(byte by, byte by2) {
        if (by == 2) {
            return rpg.b.u;
        }
        if (by == 0) {
            ...
            byArrayArray[0] = rpg.b.f[by2];
            Object object = rpg.e.a.a(by2 + 1);
            ...
            if (this.d == 5 || this.d == 8) {
                ...
                for (int i = 1; i < ((byte[])object).length; ++i) {
                    object[i] = (byte)rpg.b.d[i];
                }
    ...
    public final void a(byte[] byArray, int n, dg dg2) {
        this.g();
        if (n == 0) {
            ...
            block16: {
                block18: {
                    block17: {
                        ...
                        if (!rpg.e.a.a(by + 1)) break block17;
    ...
    protected final void a(cr cr2) {
        if (this.d < 6) {
            ...
            if (rpg.c.k != null) {
                n2 = rpg.c.k.a();
                c = rpg.c.k.b();
                for (n = 0; n < rpg.a.a; n += n2) {
                    cr2.a(rpg.c.k, n, 1, 20);
                    cr2.a(rpg.c.k, n, rpg.a.b - 1, 36);
                }
            }
            n2 = a;
            n = n2 + 21;
            ...
            for (int i = 0; i < 6; ++i) {
                int n4;
                cr2.a(1639940);
                cr2.a(0, n2, rpg.a.a, 42);
                cr2.a(0xC9C191);
                cr2.a(1, n2, rpg.a.a - 2, 1);
                cr2.a(a[i], 24, n, 3);
                if (i == this.d) {
                    cr2.b(40);
                    cr2.a(0xFFFF00);
                ...
                cr2.a(0xFFFFFF);
                dv.a(cr2, 48, n2 + 6, n3, rpg.b.g[i], 0, 0, rpg.b.g[i].length, 4);
                int n5 = i;
                switch (n5) {
                    case 1: {
                        if (dj.i) {
                ...
                if (n4 == 0) {
                    cr2.a(65535);
                    Object object = rpg.e.a.a(i + 1);
                    object = "" + object[0];
                    byte[][] byArrayArray = new byte[1][];
                    byte[][] byArrayArray2 = byArrayArray;
                    byArrayArray[0] = object.getBytes();
                    object = bd.a(rpg.b.h, byArrayArray2);
                    dv.a(cr2, rpg.a.a - 2 - dv.b(object, 0, n3), n2 + 42 - dv.a - 4, n3, object, 0, 0, ((byte[])object).length, 4);
                } else {
                    cr2.a(0x888888);
                    dv.a(cr2, rpg.a.a - 2 - dv.b(rpg.b.w, 0, n3), n2 + 42 - dv.a - 4, n3, rpg.b.w, 0, 0, rpg.b.w.length, 4);
                }
                n2 += 42;
                n += 42;
            }
    ...
    public static byte[] a(byte[][] byArray, byte[][] byArray2) {
        ...
        for (int i = 0; i < byArray2.length; ++i) {
            if (byArray2[i] != null) {
                byArray3 = rpg.f.a(byArray3, byArray2[i]);
            }
            if (byArray[i + 1] == null) continue;
            byArray3 = rpg.f.a(byArray3, byArray[i + 1]);
        }
        return byArray3;
    }
