...
implements g {
    ...
    public static final void a(short s, short s2, byte by2, byte by3) {
        short s3 = by2;
        by2 = (byte)s3;
        if (s3 < 0) {
            by2 = (byte)(by2 + 256);
        ...
        switch (by2) {
            ...
            case 111: 
            case 113: {
                new ds(s, s2, (short)by2, by3);
                return;
            }
            case 110: 
            case 112: 
            case 114: {
                new cg(s, s2, (short)by2, by3);
                return;
            }
            case 115: {
                new by(s, s2, (short)by2, by3);
                return;
            }
            case 116: {
                by.d = by2;
            ...
            case 117: 
            case 118: {
                new ad(s, s2, (short)by2, by3);
                return;
            }
        }
        if (b.a[by3].a == 4) {
            new dz(s, s2, (short)by2, by3);
            return;
        }
        if (b.a[by3].a == 5) {
            new cu(s, s2, (short)by2, by3);
            return;
        }
        new db(s, s2, by2, by3, b.a[by3].a, false);
    }

    protected db(short s, short s2) {
        super(s, s2, (byte)8, (byte)7);
        this.j = ((c)this).c;
        this.k = ((c)this).d;
        this.i((byte)2);
    }

    protected db(short s, short s2, short s3, byte by2, at at2, boolean bl) {
        this(s, s2);
        this.e = s3;
        this.a = b.a[by2];
        this.a = at2;
    ...
    protected void f() {
        ...
        if (n != 0) {
            byte by2 = db2.o;
            db2.o = (byte)((n + 1) * by2 / 5 + (n == 1 ? 40 : 60));
            db2.f = (short)(db2.f * db2.o / by2);
            db2.g = (short)(db2.g * db2.o / by2);
            db2.e = db2.d = (db2.d - 70) * (db2.o + (n == 1 ? 20 : 40)) / by2;
            db2.h = (short)((db2.h - 13) * db2.o / by2 + (n == 1 ? 20 : 40));
    ...
    protected void t() {
        int n = (do.a.nextInt() & 0xFF) % 3;
        this.o = (byte)(this.o + n);
        this.d += n * 20;
        this.e = this.d;
        this.h = (short)(this.h + n * 3);
    }
    ...
    public void a(int n, int n2) {
        n = n + ((c)this).a + ((c)this).a + (((c)this).e - 1 << 3);
        n2 = n2 + ((c)this).b + ((c)this).b + 1;
        if (this.m > 0) {
            this.m = (byte)(this.m - 1);
            n += rpg.b.S[this.n] * g.a_[this.m];
            n2 += rpg.b.T[this.n] * g.a_[this.m];
        }
        if (n < -16 || n2 < 0 || n > bh.g + 16 || n2 > bh.h + 32) {
            this.b(n, n2 - (this.a != null ? (int)this.a.h : 0), true);
            this.d(n, n2);
            ((am)this).e = false;
            if (!this.h()) {
                return;
    ...
    protected void c() {
        ...
        if (this.a == null) {
            ...
            db2 = this;
            n = this.p == 6 ? (int)rpg.c.a.a(this.i) : (int)this.a.a(this.i);
        }
        db2.c = n;
    }
    ...
    protected void w() {
        ...
        byte by3 = this.b();
        int n = Math.abs(do.a.nextInt()) % 65535;
        if (n < 52428) {
        ...
        for (int i = 0; i < 4; ++i) {
            by2 = -1;
            byte by4 = -1;
            int n2 = rpg.f.a(byArray, i * 6 + 2);
            if (n >= n2) continue;
            switch (i) {
                case 0: 
                case 1: {
                    by4 = (byte)rpg.f.a(do.a, byArray[i * 6], (int)byArray[i * 6 + 1]);
    ...
    protected void m() {
        boolean bl;
        boolean bl2 = bl = !((c)this).a && !((c)this).b;
        if (this.p == 6) {
            this.e_();
            return;
        }
        ...
        switch (this.p) {
            case 0: 
            case 1: {
                if (this.h || !bl && ((am)this).a != -1) break;
                this.n();
                return;
            }
            case 2: {
    ...
    protected void e() {
        switch (this.a.a) {
            ...
            case 2: {
                int n = ((c)this).c + rpg.b.S[this.r];
                int n2 = ((c)this).d + rpg.b.T[this.r];
                if (ab.a(n, n2)) break;
                new as(14, (short)(n << 4), (short)(n2 << 4), this.a, 4, false, this, this.a(), this.r, this.j);
                return;
            }
            case 3: {
    ...
    protected void p() {
        ...
        int n = 20 + this.b() - r.a.b();
        if (n < 0) {
            n = 0;
        } else if (n > 30) {
            n = 30;
        }
        r.a.f(18 * this.b() * n / 20);
    }
    ...
    public boolean a(do do_) {
        ...
        int n2 = 90 + this.b() - do_.b() - do_.b();
        if (n2 < 15) {
            n2 = 15;
        }
        return (n = (do.a.nextInt() & 0xFF) % 100) < n2;
    }

    protected void a(do do_, int n, byte by2, byte by3) {
    ...
    public boolean a(x do_, byte by2, int n, boolean bl, byte by3, byte by4, boolean bl2, boolean bl3, boolean bl4) {
        boolean bl5;
        if (this.d()) {
            return false;
        }
        bh.a(this, false);
        ((c)this).c = true;
        boolean bl6 = bl5 = n == -100;
        if (n == -2 || !bl5 && bl3 && !do_.a(this)) {
            this.x();
            return false;
        }
        if (n == -90) {
        ...
        if (bl5 || rpg.f.a(0, 99) < do_.a(this.b(), bl2)) {
            n += do_.a(n);
            if (by4 == 2 || by4 == 4) {
                by4 = (byte)(by4 - 1);
            }
    ...
    public boolean a(int n, byte by2) {
        if (this.d()) {
            return false;
        }
        ((c)this).c = true;
        ...
        db db2 = this;
        this.a(r.a, db.a(n, db2.i ? (db2.g << 2) / 5 : db2.g), by2, (byte)3);
        return true;
    }

    public final boolean b(int n) {
        this.a(n, rpg.b.Y[this.q]);
        return true;
    }

    protected final boolean b(do do_, int n, byte by2) {
        boolean bl = !this.a(do_);
        if (bl) {
            do_.c(new ax(do_ instanceof x ? (byte)-1 : -2));
            return false;
        }
        boolean bl2 = do_.a(this, n, by2);
        n = bl2 ? 1 : 0;
        if (bl2 && this.a != null) {
            if (this.a.b && !do_.b()) {
                do_.b(60, 30);
    ...
    protected boolean a(do do_, int n, byte by2) {
        if (this.d()) {
            return false;
        }
        if (n == -90) {
        ...
        this.c(new bj(1));
        this.a(do_, db.a(n, this.a()), by2, (byte)3);
        return true;
    }
    ...
    protected final boolean a(short s, short s2, byte by2, byte by3) {
        ab ab2 = r.a;
        int n = 0;
        while (++n < 10) {
            int n2 = rpg.f.a(do.a, by2, (int)by3);
            int n3 = s + rpg.b.S[n2];
            if (!ab2.a(this, n3, n2 = s2 + rpg.b.T[n2])) continue;
            by2 = (byte)n2;
            s2 = (short)n3;
            db db2 = this;
            db2.a((short)(s2 << 4), (short)(by2 << 4));
            db2.a();
            db2.a_();
            return true;
        }
    ...
    protected final boolean a(byte[] byArray, short s, boolean bl) {
        int n;
        int n2;
        int n3;
        int n4;
        boolean bl2 = false;
        do do_ = r.a;
        block0: for (n4 = 0; !bl2 && n4 < byArray.length; n4 += 2) {
            n3 = ((c)this).c + byArray[n4];
            n2 = ((c)this).d + byArray[n4 + 1];
            for (n = 0; !bl2 && n < ((c)this).e; ++n) {
                if (do_.c != n3 + n || do_.d != n2) continue;
                bl2 = this.b(do_, (int)s, this.q);
                if (!bl || !bl2 || !r.a.c()) continue block0;
                do_.j(this.q);
                continue block0;
            }
        }
        ...
        if (r.a != null) {
            do_ = r.a;
            block2: for (n = 0; n4 == 0 && n < byArray.length; n += 2) {
                n3 = ((c)this).c + byArray[n];
                n2 = ((c)this).d + byArray[n + 1];
                for (int i = 0; n4 == 0 && i < ((c)this).e; ++i) {
                    if (do_.c != n3 + i || do_.d != n2) continue;
                    n4 = this.b(do_, (int)s, this.q) ? 1 : 0;
                    if (!bl || n4 == 0) continue block2;
                    do_.j((byte)(n / 2 + 1));
                    continue block2;
                }
            }
