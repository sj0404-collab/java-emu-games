...
extends bm {
    ...
    private static void a(byte by, int n) {
        for (int i = 0; i <= n; ++i) {
            a[0].a(dg.a(by, (byte)i), 1);
        }
    }
    ...
    private void a(dg dg2, byte by) {
        dg2 = dg.a(dg2.g, dg2.h);
        if (r.a(dg2.g).a(dg2, (int)by) <= 0) {
            ((bm)this).a = (byte)15;
        ...
        if (this.b == 3) {
            if (by2 > 0) {
                if (this.c < 3) {
                    ...
                    r.a(this.a.g).b(this.a.g, this.a.h, by2);
                    while (by2 > 0) {
                        r.e(this.a.a / 10);
                        by2 = (byte)(by2 - 1);
                    }
    ...
    final boolean a(int n, int n2) {
        ...
        if (this.a) {
            ...
            this.e(n, n2);
            if (this.d % this.f == 0 && this.j > 1 && ah.h(n, n2)) {
                this.a = true;
                return true;
            }
            this.d(n, n2);
    ...
    protected final void a(cr cr2) {
        ...
        if (dg2 != null) {
            this.a(cr2, this.f, n + 2, dg2);
        }
        cr2.a(3550755);
        cr2.a(n2, n3, 55, 11);
        cr2.a(n2 + 1, n3 - 1, 53, 1);
        if (dg2 != null) {
            this.d(cr2, n2 + 55 - 4, n3 + 2, this.c >= 3 ? dg2.a / 10 : dg2.a);
        }
