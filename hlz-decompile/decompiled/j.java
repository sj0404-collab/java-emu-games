...
extends ah {
    ...
    public j(ah ah2, int n, int n2, int n3, byte by) {
        super(ah2, (byte)n, (byte)n2, (byte)n3);
        this.a = by;
    }
    ...
    public static void a(cr cr2, int n, int n2, int n3, int n4) {
        cr2.b(n - 1, n2 - 1, n3 + 2, n4 + 2);
        int n5 = n3 / 20 + 1;
        int n6 = n4 / 20 + 1;
        for (int i = 0; i < n5; ++i) {
            for (int k = 0; k < n6; ++k) {
                cr2.a(rpg.c.v, n + i * 20, n2 + k * 20, 20);
            }
        }
        cr2.a(15723216);
        cr2.d(n, n2, n3 - 1, n4 - 1);
        cr2.a(3550755);
        cr2.d(n - 1, n2 - 1, n3 + 1, n4 + 1);
    }
}
