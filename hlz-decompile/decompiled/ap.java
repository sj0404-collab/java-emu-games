...
extends n {
    ...
    final boolean a(int n2, int n3) {
        ...
        if (ah.f(n2, n3)) {
            if (this.c) {
                ...
                ap ap2 = this;
                n3 = 0;
                for (int i = ap2.Z.length - 1; i >= 0; --i) {
                    n3 = n3 * 10 + ap2.Z[i];
                }
                int n4 = n3;
                if (n4 != 0) {
    ...
    protected final void a(cr cr2) {
        ...
        for (n2 = 0; n2 < 2; n2 = (int)((byte)(n2 + 1))) {
            boolean bl = this.c ? this.d == n2 : this.a == n2;
            n3 = this.g + 25 + n2 * 24;
            ah.a(cr2, this.f + 3, n3, 154, 18, bl ? 0x660000 : 3550755, bl ? 0xBD0000 : 7027456);
            cr2.a(bl ? 0xFFFFFF : 12630160);
