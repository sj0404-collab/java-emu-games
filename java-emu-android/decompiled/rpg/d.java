...
public final class d {
    ...
    public static final boolean a(byte[] byArray, byte by2) {
        return d.a(a[by2], byArray, a[by2]);
    }

    public static final byte[] a(byte by2) {
        return d.a(a[by2], a[by2]);
    }

    public static final boolean b(byte[] byArray, byte by2) {
        return d.a(b[by2], byArray, b[by2]);
    }

    public static final byte[] b(byte by2) {
        return d.a(b[by2], b[by2]);
    }

    public static final boolean c(byte[] byArray, byte by2) {
        return d.a(c[by2], byArray, b[by2]);
    }

    public static final byte[] c(byte by2) {
        return d.a(c[by2], b[by2]);
    }
    ...
    private static final boolean a(String object, byte[] object2, byte[] byArray) {
        ...
        try {
            ...
            if (bv2.a != null) {
                ...
                while ((n3 = object2.a.indexOf("/")) > 0) {
                    object2.a = object2.a.substring(0, n3) + "." + object2.a.substring(n3 + 1);
                }
                if (byArray3 == null || n2 != byArray3.length) {
                    object2.a = new byte[n2];
                    System.arraycopy(byArray3, 0, object2.a, 0, n2);
                } else {
                    object2.a = byArray3;
                }
                try {
    ...
    private static final byte[] a(String object, byte[] object2) {
        ...
        try {
            ...
            byte[] byArray = d.a((byte[])object, n2 - 5, (byte)by2);
            object3 = !(object[n2 - 1] == byArray[4] && object[n2 - 2] == byArray[3] && object[n2 - 3] == byArray[2] && object[n2 - 4] == byArray[1] && object[n2 - 5] == byArray[0]) ? null : d.a(object3, (byte[])object2);
        }
        catch (Exception exception) {
            object3 = null;
    ...
    private static final byte[] a(byte[] byArray, int n2, byte by2) {
