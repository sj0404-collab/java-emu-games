...
extends j {
    ...
    private eb(ah ah2, byte[] byArray, byte[][] byArray2, boolean n2) {
    ...
    private eb(ah ah2, byte[] byArray, byte by2) {
    ...
    eb(ah ah2, byte[] byArray, byte by2, boolean bl2) {
        this(ah2, byArray, by2);
    }
    ...
    protected final void a(cr cr2) {
        ...
        if (rpg.c.k != null) {
            int n6 = rpg.c.k.a();
            for (int i2 = 0; i2 < rpg.a.a; i2 += n6) {
                cr2.a(rpg.c.k, i2, 0, 20);
                cr2.a(rpg.c.k, i2, rpg.a.b, 36);
            }
            if (this.b != null) {
