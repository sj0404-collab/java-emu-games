...
extends cf {
    ...
    public cg(short s2, short s3, short s4, byte by2) {
        super(s2, s3, s4, by2);
        this.g = (byte)3;
        this.Z = new byte[]{0};
    ...
    protected final void e() {
        switch (this.u) {
            ...
            case 2: {
                int by2 = Math.abs(this.a[0] - ((c)this).c);
                int n2 = Math.abs(this.a[1] - ((c)this).c);
                int n3 = Math.abs(this.a[2] - ((c)this).d);
                int n4 = Math.abs(this.a[3] - ((c)this).d);
                byte by3 = by2 > n2 ? this.a[0] : this.a[1];
                byte by4 = n3 > n4 ? this.a[2] : this.a[3];
                this.a(by3, by4, true);
                return;
            }
            case 3: {
