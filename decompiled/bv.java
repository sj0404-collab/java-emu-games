...
public final class bv {
    ...
    public bv(String string, byte by2) {
        this.a = string;
        if (by2 == 1) {
    ...
    public final void a(byte[] byArray, int n2, int n3) {
        try {
            this.a = this.a;
            System.arraycopy(this.a, this.a, byArray, 0, n3);
            this.a += n3;
            return;
        }
    ...
    private boolean a() {
        ...
        while ((n2 = this.a.indexOf("/")) > 0) {
            this.a = this.a.substring(0, n2) + "." + this.a.substring(n2 + 1);
        }
        try {
