...
implements rpg.b {
    ...
    public final void b() {
        ...
        g = dq2.a(0);
        for (n2 = 0; n2 < 4; ++n2) {
            rpg.c.h[n2] = dq2.a(n2 + 1);
            rpg.c.i[n2] = cw.a("/miss" + n2 + ".png");
        }
    ...
    public final void a(byte[] byArray) {
        ...
        for (int i2 = 0; i2 < 6; ++i2) {
            int n2;
            if (byArray[i2] < 0 || (n2 = rpg.c.a(byArray[i2])) < 0) continue;
            rpg.c.f[n2] = cw.a("/img/face_" + n2 + ".png");
        }
    }
    ...
    public static void a(byte by2, byte by3) {
        dq dq2 = new dq("/img/s");
        boolean bl2 = false;
        if (by2 >= 7 && by2 <= 17) {
            bl2 = true;
        ...
        for (by2 = 0; by2 < 2; by2 = (byte)(by2 + 1)) {
            rpg.c.e[by2] = dq2.a(by2 + (bl2 ? 2 : 0));
        }
    }

    public static void a(int n2, int n3, byte[] byArray, byte[] byArray2, byte[] byArray3) {
        if (n3 < 0) {
            n3 += 256;
        }
        b.a((byte)n2, (short)n3, byArray, byArray2, byArray3);
    }
    ...
    public static void f() {
        ...
        m = new cw[3];
        for (n2 = 0; n2 < 3; ++n2) {
            rpg.c.m[n2] = dq2.a(n2 + 1);
        }
    }

    private static cw a(byte[] byArray) {
        int n2 = dv.a(byArray) + 2;
        int n3 = dv.a + 2;
        ...
        cr2.a(0, 0, n2, n3);
        cr2.a(0x3F1F3F);
        dv.a(cr2, 0, 0, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 0, 1, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 0, 2, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 1, 0, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 1, 2, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 2, 0, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 2, 1, n2, byArray, 0, 0, byArray.length, 20);
        dv.a(cr2, 2, 2, n2, byArray, 0, 0, byArray.length, 20);
        cr2.a(14597755);
        dv.a(cr2, 1, 1, n2, byArray, 0, 0, byArray.length, 20);
        cw2.a(nArray, 0, n2, 0, 0, n2, n3);
        for (int i2 = n2 * n3 - 1; i2 >= 0; --i2) {
            if (nArray[i2] != -1) continue;
            nArray[i2] = 0;
        }
        cw2 = cw.a(nArray, n2, n3, true);
        return cw2;
    }
    ...
    public static void g() {
        ...
        System.out.println("go to map : " + n2);
        if (ab.a != null) {
            ab.a = null;
        }
        if (r.a != null) {
        ...
        if (n2 < 100) {
            byArray = rpg.c.a("/m/m/" + (n2 < 10 ? "0" : "") + n2 + ".m");
        } else {
            int n3 = n2 % 10;
            ...
            byArray = rpg.c.a("/m/m2/" + new String(byArray3) + n3 + ".m");
        }
        r.a = new ab(r.a);
        r.a.a(byArray);
        r.a.b();
    ...
    public static final byte[] a(String object, int n2) {
        ...
        try {
            ...
            object = byArray2;
            byArray = rpg.c.a(byArray2, n2);
        }
        catch (Exception exception) {}
        return byArray;
    }

    public static final byte[] a(byte[] byArray, int n2) {
        short s2;
        int n3 = 0;
        for (int i2 = 0; i2 < n2; ++i2) {
            s2 = rpg.f.b(byArray, n3);
            n3 += s2 + 2;
        }
        s2 = rpg.f.b(byArray, n3);
    ...
    public static void a(bb bb2, int n2) {
        Object object = r.a;
        byte by2 = 0;
        byte by3 = 0;
        int n3 = -1;
        if ((object = ((x)object).a(a[n2])) != null) {
            by2 = ((dg)object).g;
            by3 = ((bs)object).d;
            n3 = ((bs)object).a;
            if (by3 < 0) {
        ...
        switch (n2) {
            ...
            case 2: 
            case 3: {
                object = "/hero/" + n2 + "/" + (r.a() ? "" : "l") + (by3 < 10 ? "0" : "") + by3;
                break;
            }
            case 4: {
                object = "/hero/" + n2 + "/" + r.b;
        ...
        byte[] byArray = null;
        if (n3 >= 0) {
            byArray = rpg.c.a("/hero/h.p", n3);
        }
        bb2.a(n2, (String)object, byArray);
    }

    public static void a(byte[] byArray, byte by2, byte by3, byte[] byArray2) {
        byArray = rpg.c.a(byArray, (int)by2);
        dt.a(byArray, by3, byArray2);
    }
