...
extends j {
    ...
    public bi(ah ah2, byte[] byArray, char c2) {
    ...
    public bi(ah ah2, byte[] byArray, byte by2) {
        this(ah2, byArray, '\u0000');
        ((j)this).a = by2;
    }
    ...
    boolean a(int n2, int n3) {
        ...
        if (((ah)this).a != null && (ah.f(n2, n3) || ah.g(n2, n3))) {
    ...
    protected void a(cr cr2) {
        ...
        if (this.c) {
            ...
            int n3 = this.a.length - this.j % 4;
            byte[] byArray = new byte[n3];
            System.arraycopy(this.a, 0, byArray, 0, n3);
            dv.a(cr2, ((j)this).a + 8, n2, byArray, 0);
            ((ah)this).d = true;
            return;
        }
        if (this.e == 1) {
            dv.a(cr2, rpg.a.c, n2, this.a, 1, 1);
            return;
        }
        dv.a(cr2, ((j)this).a + 8, n2, 144, 1, this.a);
    }
}
